...
def regenerate_music_low_intensity(StoryInfoObj, chapter):
    ...
    # this_duration = sum(StoryInfoObj.durations, StoryInfoObj.chapterCount * 2)
    # print(f'Low intensity song duration: {this_duration} \n')
...
def regenerate_music_med_intensity(StoryInfoObj, chapter):
    ...
    # this_duration = sum(StoryInfoObj.durations, StoryInfoObj.chapterCount * 2)
    # print(f'Medium intensity song duration: {this_duration} \n')
...
def regenerate_music_high_intensity(StoryInfoObj, chapter):
    ...
    # this_duration = sum(StoryInfoObj.durations, StoryInfoObj.chapterCount * 2)
    # print(f'High intensity song duration: {this_duration} \n')
